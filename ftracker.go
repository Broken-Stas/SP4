...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	runningEnergy := ((runningCaloriesMeanSpeedMultiplier * meanSpeed(action, duration) * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	walkingEnergy := (walkingCaloriesWeightMultiplier*weight + (math.Pow(meenSpeedInMsec, 2)/(height/cmInM))*walkingSpeedHeightMultiplier*weight) * duration * minInH
	return walkingEnergy
}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	swimmingEnergy := (swimmingMeanSpeed(lengthPool, countPool, duration) + swimmingCaloriesMeanSpeedShift) * weight * swimmingCaloriesWeightMultiplier * duration
	return swimmingEnergy
}
